package love.moon.dubbo.demo.zookeeper.publish;
...
import static love.moon.dubbo.demo.zookeeper.publish.Publish.ZK_ADDRESS;
...
public class Subscribe implements Watcher {
    ...
    public static void main(String[] args) {
        try {
            String path = "/publish";
            zk = new ZooKeeper(ZK_ADDRESS, SESSION_TIMEOUT, new Subscribe());
            latch.await();
